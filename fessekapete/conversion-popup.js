function initConversionPopup() {
    ...
    const content = {
        fr: {
            ...
            trigger: "<span class=\"trigger-text\">Offre du moment</span> <span class=\"trigger-icon\">🎁</span>"
        },
        en: {
            ...
            trigger: "<span class=\"trigger-text\">Special Offer</span> <span class=\"trigger-icon\">🎁</span>"
        }
    };
    ...
    style.innerHTML = `
        ...
        @media (max-width: 768px) {
            .conversion-popup-trigger-wrapper { bottom: 180px; left: 16px; transform-origin: bottom left; transform: scale(0.9) translateY(20px); }
            .conversion-popup-trigger-wrapper.visible { transform: scale(0.9) translateY(0); }
            .trigger-text { display: none; }
            .conversion-popup-trigger-main { width: 50px; height: 50px; padding: 0; display: flex; align-items: center; justify-content: center; border-radius: 50%; }
            .trigger-icon { font-size: 1.4rem; }
            .conversion-popup-trigger-close { position: absolute; top: -10px; right: -10px; z-index: 10; }
        }
    `;
    ...
    // If they click the main CTA, do whatever (we still allow the popup process naturally)

...
(function () {
    ...
    document.getElementById('cb-accept').addEventListener('click', function() {
        ...
        gtag('config', 'G-S30RM9RR91', {
            'transport_url': 'https://www.stratads.fr/assets/lib/web-vitals',
            'update': true
        });

        sessionStorage.setItem('sa_cookie_dismissed', 'true');
        document.querySelector('.cookie-banner').classList.add('launched');
    });
